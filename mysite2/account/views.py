...
def myself_edit(request):
    ...
    if request.method == "POST":
        ...
        if user_form.is_valid() * userprofile_form.is_valid() * userinfo_form.is_valid():
            ...
            userinfo.aboute = userinfo_cd['aboute']
            request.user.save()
            userprofile.save()
            userinfo.save()
        ...
        userinfo_form = UserInfoForm(initial={"school":userinfo.school, "company":userinfo.company, "profession":userinfo.profession, "address":userinfo.address, "aboute":userinfo.aboute})
